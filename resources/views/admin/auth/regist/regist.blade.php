                        ...
                        <form method="POST" action="{{url('registrasi')}}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{old('nama')}}" type="text" placeholder="Username" autofocus />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input name="surel" class="form-control @error('surel') is-invalid @enderror" value="{{old('surel')}}" type="text" placeholder="Surel" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input id="sandi" name="sandi" class="form-control @error('sandi') is-invalid @enderror" type="password" placeholder="Sandi" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input id="konfirm-sandi" name="sandi_confirmation" class="form-control" type="password" placeholder="Konfirm Sandi" />
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                <div class="form-check">
                                    <input id="tampil-sandi" class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
